 ...
 <?php
    ...
    $sql = "SELECT * FROM `tbljob` j INNER JOIN `tblcompany` c ON j.COMPANYID = c.COMPANYID WHERE j.COMPANYID = $jobid AND j.CATEGORY = '$jobposition'" ;
    $mydb->setQuery($sql);
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="row contentbody">
                                          ...
                                          <a href="<?php echo web_root; ?>index.php?q=apply&companyId=<?php echo $jobid;?>&jobposition=<?php echo $jobposition;?>" class="btn btn-main btn-next-tab">Apply Now !</a>
                                    </div>
                                </div>
                            </div> 
                        </div>
