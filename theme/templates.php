...
<head>
<meta charset="utf-8">
<title>RSMS / <?php echo $title;?></title>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">RSMS<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                      ...
                      <li class="dropdown <?php  if(isset($_GET['q'])) { if($_GET['q']=='category'){ echo 'active'; }else{ echo ''; }}  ?>">
                          <a href="#" data-toggle="dropdown" class="dropdown-toggle">Job Position <b class="caret"></b></a>
                          <ul class="dropdown-menu">
                            <?php 
                       ...
                       <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='category'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=job position">Job Position</a></li>
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='hiring'){ echo 'active'; }else{ echo ''; }} ?>"><a href="<?php echo web_root; ?>index.php?q=hiring">Apply Now</a></li>
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='About'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=About">Contributors</a></li>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          <h3 class="widgetheading">Department of Education Philippines</h3>
          <address>
          <strong>National Capital Region</strong><br>
          Schools Division Office of Valenzuela City<br>
          Pio Valenzuela Street, Brgy. Marulas, Valenzuela City</address>
          <p>
            <i class="icon-phone"></i> Admin Contact Number: 8292 3247 <br>
            <i class="icon-envelope-alt"></i> Personnel Unit Contact Number: 8293 4507 
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
        <div class="widget"><br>
          ...
          <ul class="link-list">
            ...
            <li><a href="<?php echo web_root; ?>index.php?q=hiring">Apply Now</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=About">Contributors</a></li>
      ...
      <div class="col-md-4 col-sm-4">
        <div class="widget"><br>
          <h4 class="widgetheading">Official Email</h4>
          <ul class="link-list">
          <li><a href="https://sites.google.com/deped.gov.ph/recruitment-sdoval/dashboard" target="_blank" rely="noopener noreferrer">sdovalenzuela@deped.gov.ph</a></li>
          </ul>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>Copyright &copy; 2022 All right reserved. Design by:    ICTU  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
          <ul class="social-network">
            <li><a href="https://www.facebook.com/sdovaldeped "target="_blank" rely="noopener noreferrer" data-placement="top" title="Facebook"><i class="fa fa-facebook"></i></a></li>
            <li><a href="mailto:someone@yoursite.com" target="_blank" rely="noopener noreferrer" data-placement="top" title="Email"><i class="fa fa-envelope"></i></a></li>
            <li><a href="https://accounts.google.com/" target="_blank" rely="noopener noreferrer" data-placement="top" title="Gmail"><i class="fa fa-share"></i></a></li>
          </ul>
        </div>
      </div>
    </div>
